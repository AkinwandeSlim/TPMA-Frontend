...
// // Validation schema
// export const StudentEvaluationSchema = z.object({
//   tpAssignmentId: z.string().min(1, "TP Assignment ID is required"),
...
//           "http://localhost:5000/api/admin/student_evaluations",
//           formData,
...
//           `http://localhost:5000/api/admin/student_evaluations/${data.id}`,
//           formData,
//           { headers: { Authorization: `Bearer ${token}` } }
//         );
//         toast.success("Student evaluation updated successfully");
...
//     } catch (error: any) {
//       console.error(`Error ${type} student evaluation:`, error);
//       toast.error(error.response?.data?.error || `Failed to ${type} student evaluation`);
//     }
//   };
