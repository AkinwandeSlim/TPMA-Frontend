...
//     className: string;
//     submittedAt: string;
//     content: string; // Assuming the lesson plan has a content field
//   };
// };
...
//         <div className="flex flex-col gap-2">
//           <p className="text-sm text-gray-700">
//             <span className="font-medium">Trainee:</span> {lessonPlan.traineeName}
//           </p>
//           <p className="text-sm text-gray-700">
//             <span className="font-medium">Subject:</span> {lessonPlan.subject}
//           </p>
//           <p className="text-sm text-gray-700">
//             <span className="font-medium">Class:</span> {lessonPlan.className}
//           </p>
//           <p className="text-sm text-gray-700">
//             <span className="font-medium">Submitted:</span>{" "}
//             {new Intl.DateTimeFormat("en-GB").format(new Date(lessonPlan.submittedAt))}
//           </p>
//           <div className="mt-2">
//             <span className="font-medium text-sm">Content:</span>
//             <p className="text-sm text-gray-700 mt-1">{lessonPlan.content || "No content available."}</p>
