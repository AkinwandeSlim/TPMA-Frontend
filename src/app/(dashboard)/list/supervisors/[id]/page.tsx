...
//   verifyToken,
//   getSupervisor,
//   getSupervisedTraineesCount,
//   getSupervisorLessons,
//   getSupervisorLessonPlans,
//   getTraineesAverageProgress,
//   sendFeedback,
//   reviewLessonPlan,
//   generateSupervisorReport,
// } from "@/lib/api";

// // Type definitions aligned with lib/api.ts schemas
// type Supervisor = {
//   id: string;
//   staffId: string;
//   name: string;
...
//       ] = await Promise.all([
//         getSupervisor(id),
//         getSupervisedTraineesCount(id),
//         getSupervisorLessons(id, 1, 100), // Fetch up to 100 lessons to avoid pagination issues
//         getSupervisorLessonPlans(id, 1, 10, undefined, undefined, "PENDING,APPROVED,REJECTED"),
//         getSupervisorLessonPlans(id, 1, 10, undefined, undefined, "PENDING"),
//         getTraineesAverageProgress(id),
//       ]);

//       setSupervisor(supervisorData);
//       setSupervisedTraineesCount(traineesCountData.count || 0);
//       setLessons(lessonsData.lessons || []);
//       setLessonPlans(lessonPlansData.lessonPlans || []);
//       setPendingLessonPlansCount(pendingPlansData.lessonPlans?.length || 0);
//       setAverageTraineeProgress(progressData.averageProgress || 0);
//     } catch (err: any) {
//       console.error("Error fetching supervisor data:", err);
//       setError(
//         err.message === "Failed to fetch supervisor"
...
//         throw new Error("Trainee or supervisor not selected");
//       }
//       await sendFeedback({
...
//         throw new Error("Supervisor not found");
//       }
//       await reviewLessonPlan(supervisor.id, lessonPlanId, {
//         status,
//         comments: feedback,
//       });
//       toast.success("Lesson plan reviewed successfully");
...
//   const handleGenerateSupervisorReport = async () => {
//     try {
//       const pdfUrl = await generateSupervisorReport(id);
//       const link = document.createElement("a");
//       link.href = pdfUrl;
//       link.setAttribute("download", `supervisor_${id}_report.pdf`);
//       document.body.appendChild(link);
...
//     "15:00",
//   ];
//   const days = ["2025-04-07", "2025-04-08", "2025-04-09", "2025-04-10", "2025-04-11"];
//   const startDate = new Date("2025-04-07");
...
//               <Image
//                 src={supervisor.img || "/noAvatar.png"}
//                 alt={`${supervisor.name} ${supervisor.surname}`}
//                 width={144}
//                 height={144}
//                 className="w-36 h-36 rounded-full object-cover"
//               />
...
//                 </div>
//                 <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
//                   <Image src="/date.png" alt="Created At" width={14} height={14} />
...
//               <div>
//                 <h1 className="text-xl font-semibold">
//                   {supervisor.assignedTrainees[0]?.schoolName || "N/A"}
//                 </h1>
//                 <span className="text-sm text-gray-400">Place of Supervision</span>
//               </div>
//             </div>
...
//                   <div className="flex-1 flex flex-col">
//                     <span className="font-semibold text-sm">
//                       {lessonPlan.traineeName} - {lessonPlan.subject} ({lessonPlan.class})
//                     </span>
//                     <span className="text-xs text-gray-500">
//                       Submitted: {formatDate(lessonPlan.createdAt)}
//                     </span>
...
//       //   progressRes,
//       // ] = await Promise.all([
//       //   fetch(`http://localhost:5000/api/supervisors/${id}`, {
//       //     headers: { Authorization: `Bearer ${token}` },
//       //   }),
//       //   fetch(`http://localhost:5000/api/supervisors/${id}/trainees-count`, {
//       //     headers: { Authorization: `Bearer ${token}` },
//       //   }),
//       //   fetch(`http://localhost:5000/api/lessons/supervisor/${id}`, {
//       //     headers: { Authorization: `Bearer ${token}` },
//       //   }),
//       //   fetch(`http://localhost:5000/api/supervisors/${id}/lesson-plans`, {
//       //     headers: { Authorization: `Bearer ${token}` },
//       //   }),
//       //   fetch(`http://localhost:5000/api/supervisors/${id}/lesson-plans?status=PENDING`, {
//       //     headers: { Authorization: `Bearer ${token}` },
//       //   }),
//       //   fetch(`http://localhost:5000/api/supervisors/${id}/trainees-average-progress`, {
//       //     headers: { Authorization: `Bearer ${token}` },
//       //   }),
//       // ]);
...
//           headers: { Authorization: `Bearer ${token}` },
//         }),
//         fetch(`${API_BASE_URL}/api/supervisors/feedback`, {
//           headers: { Authorization: `Bearer ${token}` },
//         }),
//       ]);
...
//       await fetch(`${API_BASE_URL}/api/supervisors/feedback`, {
...
//     verifyAndFetch();
//   }, [id, fetchSupervisorData]); // Added fetchSupervisorData
...
//                     </span>
//                     <span className="text-xs text-gray-500">
//                       Submitted: {formatDate(lessonPlan.submittedAt)}
//                     </span>
//                     <span className="text-xs text-gray-500">Status: {lessonPlan.status}</span>
//                     {lessonPlan.feedback && (
//                       <span className="text-xs text-gray-500">Feedback: {lessonPlan.feedback}</span>
...
//             <button
//               onClick={handleGenerateSupervisorReport}
//               className="p-3 rounded-md bg-lamaYellowLight hover:bg-lamaYellow"
//             >
//               Generate Supervisor Report
//             </button>
//           </div>
