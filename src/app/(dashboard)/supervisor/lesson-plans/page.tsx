...
//   schedules: Schedule[];
//   message: string;
//   feedback: unknown; // Changed from any to unknown as it's not used
// };
...
//         const schedulesWithFallback = Array.isArray(scheduleData)
//           ? scheduleData.map((s) => {
//               const lessonPlan = paginatedPlans.find((lp) => lp.id === s.lesson_plan_id);
//               const fallbackLessonPlanTitle = lessonPlan?.title || "Unknown Lesson Plan";
//               const fallbackTraineeName = lessonPlan?.traineeName || s.traineeId || "Unknown Trainee";
//               console.log(`Processing schedule ${s.id}:`, {
//                 apiLessonPlanTitle: s.lessonPlanTitle,
//                 apiTraineeName: s.traineeName,
//                 fallbackLessonPlanTitle,
//                 fallbackTraineeName,
//               });
//               return {
//                 ...s,
//                 supervisorId: s.supervisorId || user.identifier,
//                 start_time: normalizeTime(s.start_time),
//                 end_time: normalizeTime(s.end_time),
//                 lessonPlanTitle: s.lessonPlanTitle || fallbackLessonPlanTitle,
//                 traineeName: s.traineeName || fallbackTraineeName,
//               };
//             })
//           : [];
...
//         const newSchedule = response.schedules[0];
//         if (newSchedule) {
//           const lessonPlanTitle = newSchedule.lessonPlanTitle || lessonPlan.title || "Unknown Lesson Plan";
//           const traineeName = newSchedule.traineeName || lessonPlan.traineeName || "Unknown Trainee";
//           console.log("New Schedule:", { id: newSchedule.id, lessonPlanTitle, traineeName });
//           setState((prev) => ({
//             ...prev,
//             newScheduleId: newSchedule.id,
//             schedules: [
//               ...prev.schedules.filter((s) => s.id !== newSchedule.id),
//               {
//                 ...newSchedule,
//                 supervisorId: newSchedule.supervisorId || user.identifier,
//                 start_time: normalizeTime(newSchedule.start_time),
//                 end_time: normalizeTime(newSchedule.end_time),
//                 lessonPlanTitle,
//                 traineeName,
//               },
//             ],
...
//         const lessonPlanTitle = newSchedule.lessonPlanTitle || lessonPlan?.title || "Unknown Lesson Plan";
//         const traineeName = newSchedule.traineeName || lessonPlan?.traineeName || "Unknown Trainee";
//         console.log("New Schedule (Observation):", { id: newSchedule.id, lessonPlanTitle, traineeName });
//         setState((prev) => ({
//           ...prev,
//           newScheduleId: newSchedule.id,
//           schedules: [
...
//           score: data.score,
//         };
//         await submitObservationFeedback(user.identifier, observationId, feedback);
//         toast.success("Feedback submitted successfully");
//         fetchData(state.currentPage, false, true);
//       } catch (err: any) {
//         toast.error(`Error: ${err.message}`);
...
// //       try {
// //         await submitObservationFeedback(user.identifier, observationId, data);
// //         toast.success("Feedback submitted successfully");
// //         fetchData(state.currentPage, false, true);
// //       } catch (err: any) {
// //         toast.error(`Error: ${err.message}`);
// //       }
// //     },
// //     [user, router, state.currentPage, fetchData]
// //   );
...
// //       { header: "Title", accessor: "title", sortable: true, field: "title" },
// //       { header: "Subject", accessor: "subject", className: "hidden md:table-cell", sortable: true, field: "subject" },
// //       { header: "Class", accessor: "className", className: "hidden md:table-cell", sortable: true, field: "className" },
// //       { header: "Trainee", accessor: "traineeName", className: "hidden md:table-cell", sortable: true, field: "traineeName" },
// //       { header: "Date", accessor: "date", sortable: true, field: "date" },
// //       { header: "Time", accessor: "time", sortable: false },
// //       { header: "Status", accessor: "status", sortable: true, field: "status" },
...
// // //       fetchData(newPage, false, type === "schedules");
// // //     },
// // //     [state.totalPages,state.isFetching,state.currentPage, state.totalSchedulePages, state.currentSchedulePage, fetchData]
// // //   );
...
// // //       { header: "Subject", accessor: "subject", className: "hidden md:table-cell", sortable: true, field: "subject" },
// // //       { header: "Class", accessor: "className", className: "hidden md:table-cell", sortable: true, field: "className" },
// // //       { header: "Trainee", accessor: "traineeName", className: "hidden md:table-cell", sortable: true, field: "train therapies" },
// // //       { header: "Date", accessor: "date", sortable: true, field: "date" },
// // //       { header: "Time", accessor: "time", sortable: false },
// // //       { header: "Status", accessor: "status", sortable: true, field: "status" },
// // //       { header: "Actions", accessor: "action" },
...
// // // // const SupervisorLessonPlanPage = ({ searchParams }: { searchParams: { [key: string]: string | undefined } }) => {
// // // //   const { user, loading: authLoading, error: authError } = useAuth();
// // // //   const router = useRouter();
// // // //   const initialFetchRef = useRef(true);
// // // //   const fetchCountRef = useRef(0);
...
// // // //         // Fetch all data using getSupervisorProfile
// // // //         const profileData = await getSupervisorProfile(user.identifier);
// // // //         console.log("Profile Data:", profileData);

// // // //         // Filter lesson plans client-side
// // // //         let filteredPlans = profileData.lessonPlans;
// // // //         if (statusFilter) {
// // // //           const statuses = statusFilter.split(",");
// // // //           filteredPlans = filteredPlans.filter((plan) => statuses.includes(plan.status));
// // // //         }
...
// // // //         // Paginate lesson plans
// // // //         const startIndex = (pageToFetch - 1) * 10;
// // // //         const paginatedPlans = filteredPlans.slice(startIndex, startIndex + 10);
// // // //         const totalCount = filteredPlans.length;
// // // //         const totalPages = Math.ceil(totalCount / 10) || 1;

// // // //         // Process schedules with fallback to lessonPlans
// // // //         const scheduleData = profileData.schedules;
// // // //         console.log("Schedules Data:", scheduleData);

// // // //         const schedulesWithFallback = Array.isArray(scheduleData)
// // // //           ? scheduleData.map((s: any) => {
// // // //               const lessonPlan = paginatedPlans.find((lp: any) => lp.id === s.lesson_plan_id);
// // // //               const fallbackLessonPlanTitle = lessonPlan ? lessonPlan.title : "Unknown Lesson Plan";
// // // //               const fallbackTraineeName = lessonPlan ? lessonPlan.traineeName : s.traineeId || "Unknown Trainee";
// // // //               console.log(`Processing schedule ${s.id}:`, {
// // // //                 apiLessonPlanTitle: s.lessonPlanTitle,
// // // //                 apiTraineeName: s.traineeName,
// // // //                 fallbackLessonPlanTitle,
...
// // // //           return {
// // // //             ...prev,
// // // //             lessonPlans: paginatedPlans.map((lp: any) => ({
// // // //               ...lp,
// // // //               traineeName: lp.traineeName || lp.traineeId || "Unknown Trainee",
// // // //               schoolName: lp.schoolName || "Not Assigned",
// // // //             })),
...
// // // //           setTimeout(() => setState((prev) => ({ ...prev, newScheduleId: null })), 3000);
// // // //         } else {
// // // //           console.warn("No schedule created in response");
// // // //         }
// // // //         fetchData(state.currentPage, false, true);
// // // //       } catch (err: any) {
// // // //         console.error("Approval Error:", err);
...
// // // //         // Fetch feedback (placeholder, update with API if available)
...
// // // //             totalFeedbackPages: Math.max(1, Math.ceil(feedbackData.length / 10)),
...
// // // //       }
// // // //     },
// // // //     [user, authError, authLoading, router, searchQuery, memoizedFilterConfig, getToken, state.feedback]
// // // //   );

// // // //   const handlePageChange = useCallback(
// // // //     (newPage: number, type: "lessonPlans" | "schedules" | "feedback") => {
// // // //       if (
// // // //         (type === "lessonPlans" && (newPage < 1 || newPage > state.totalPages || newPage === state.currentPage)) ||
// // // //         (type === "schedules" && (newPage < 1 || newPage > state.totalSchedulePages || newPage === state.currentSchedulePage)) ||
// // // //         (type === "feedback" && (newPage < 1 || newPage > state.totalFeedbackPages || newPage === state.currentFeedbackPage))
// // // //       ) {
// // // //         return;
// // // //       }
// // // //       fetchData(newPage, false, type === "schedules");
// // // //     },
// // // //     [state.totalPages, state.currentPage, state.totalSchedulePages, state.currentSchedulePage, state.totalFeedbackPages, state.currentFeedbackPage, fetchData]
// // // //   );
...
// // // //       console.log(`Rendering feedback ${item.id}:`, {
// // // //         lesson_plan_id: item.lesson_plan_id,
// // // //         title: state.lessonPlans.find((lp) => lp.id === item.lesson_plan_id)?.title,
// // // //         traineeName: state.lessonPlans.find((lp) => lp.id === item.lesson_plan_id)?.traineeName,
// // // //       });
// // // //       return (
// // // //         <tr
// // // //           key={item.id}
...
// // // //         >
// // // //           <td className="p-4">
// // // //             {state.lessonPlans.find((lp) => lp.id === item.lesson_plan_id)?.title || "N/A"}
// // // //           </td>
// // // //           <td>{state.lessonPlans.find((lp) => lp.id === item.lesson_plan_id)?.traineeName || item.traineeId}</td>
// // // //           <td>{item.score ?? "N/A"}/10</td>
// // // //           <td>{item.comments}</td>
...
// // // //       <h2 className="text-lg font-semibold mt-8 mb-4">Observation Feedback History</h2>
...
// // // //             onPageChange={(newPage) => handlePageChange(newPage, "feedback")}
// // // //           />
// // // //         </>
// // // //       )}
...
// // // //   //       // Fetch lesson plans
// // // //   //       const lessonPlanData = await getSupervisorLessonPlans(
// // // //   //         user.identifier,
// // // //   //         pageToFetch,
// // // //   //         10,
// // // //   //         searchQuery,
// // // //   //         memoizedFilterConfig.subject,
// // // //   //         statusFilter
// // // //   //       );
// // // //   //       console.log("LESSONPLANDATA: ",lessonPlanData);

// // // //   //       // Fetch schedules
// // // //   //       let scheduleData = state.schedules;
// // // //   //       if (fetchSchedules) {
// // // //   //         const response = await getSupervisorSchedules(user.identifier, pageToFetch, 10);
// // // //   //         scheduleData = response.schedules;
// // // //   //       }
// // // //   //        console.log("SCHEDULED_DATA: ",scheduleData);
...
// // // //   //       setState((prev) => ({
// // // //   //         ...prev,
// // // //   //         lessonPlans: lessonPlanData.lessonPlans.map((lp: any) => ({
// // // //   //           ...lp,
// // // //   //           traineeName: lp.traineeName || lp.traineeId || "Unknown Trainee",
// // // //   //           schoolName: lp.schoolName || "Not Assigned",
// // // //   //         })),
// // // //   //         schedules: Array.isArray(scheduleData) ? scheduleData : prev.schedules,
// // // //   //         feedback: feedbackData,
// // // //   //         totalCount: lessonPlanData.totalCount,
// // // //   //         totalPages: lessonPlanData.totalPages,
// // // //   //         currentPage: pageToFetch,
// // // //   //         totalSchedules: scheduleData?.totalCount || prev.totalSchedules,
// // // //   //         totalSchedulePages: scheduleData?.totalPages || prev.totalSchedulePages,
// // // //   //         currentSchedulePage: pageToFetch,
// // // //   //         totalFeedback: feedbackData.length,
// // // //   //         totalFeedbackPages: Math.max(1, Math.ceil(feedbackData.length / 10)),
// // // //   //         currentFeedbackPage: pageToFetch,
...
// // // //   //     }
// // // //   //   },
// // // //   //   [user, authError, authLoading, router, searchQuery, memoizedFilterConfig, getToken, state.schedules, state.feedback]
// // // //   // );
...
// // // //       // Filter lesson plans client-side (mimic getSupervisorLessonPlans logic)
// // // //       let filteredPlans = profileData.lessonPlans;
// // // //       if (statusFilter) {
// // // //         const statuses = statusFilter.split(",");
// // // //         filteredPlans = filteredPlans.filter((plan) => statuses.includes(plan.status));
...
// // // //       // Use schedules from profileData
// // // //       const scheduleData = profileData.schedules;
...
// // // //           schoolName: lp.schoolName || "Not Assigned",
// // // //         })),
// // // //         schedules: Array.isArray(scheduleData)
// // // //           ? scheduleData.map((s: any) => ({
// // // //               ...s,
// // // //               start_time: normalizeTime(s.start_time),
// // // //               end_time: normalizeTime(s.end_time),
...
// // // //         totalSchedulePages: Math.ceil(scheduleData.length / 10) || 1,
// // // //         currentSchedulePage: pageToFetch,
// // // //         totalFeedback: feedbackData.length,
// // // //         totalFeedbackPages: Math.max(1, Math.ceil(feedbackData.length / 10)),
// // // //         currentFeedbackPage: pageToFetch,
...
// // // //         if (data.status === "APPROVED") {
// // // //           // Open schedule modal with pre-filled details
// // // //           setState((prev) => ({
// // // //             ...prev,
// // // //             reviewModal: { isOpen: false, lessonPlanId: null },
// // // //             scheduleModal: {
...
// // // //   //       const newSchedule = response.schedule;
// // // //   //       if (newSchedule) {
// // // //   //         setState((prev) => ({ ...prev, newScheduleId: newSchedule.id }));
// // // //   //         setTimeout(() => setState((prev) => ({ ...prev, newScheduleId: null })), 3000);
// // // //   //       }
// // // //   //       fetchData(state.currentPage, false, true);
// // // //   //     } catch (err: any) {
...
// // // //           console.warn("No schedule created in response");
// // // //         }
// // // //         fetchData(state.currentPage, false);
// // // //       } catch (err: any) {
// // // //         console.error("Approval Error:", err);
// // // //         toast.error(`Error: ${err.message}`);
// // // //       }
...
// // // //           end_time: data.endTime,
// // // //         });
// // // //         setState((prev) => ({ ...prev, newScheduleId: response.schedule.id }));
// // // //         setTimeout(() => setState((prev) => ({ ...prev, newScheduleId: null })), 3000);
// // // //         fetchData(state.currentPage, false, true);
// // // //       } catch (err: any) {
// // // //         toast.error(`Error: ${err.message}`);
...
// // // //       authCheckRef.current = true;
// // // //       if (initialFetchRef.current) {
// // // //         fetchData(1, true); // Fetch all data initially
// // // //         initialFetchRef.current = false;
// // // //       }
// // // //     }, 2000);
// // // //     return () => clearTimeout(timer);
...
// // // //   // console.log("OUR SCHDULE: ",Schedule);
// // // //   const renderScheduleRow = useCallback(
// // // //     (item: Schedule) => (
// // // //       <tr
// // // //         key={item.id}
...
// // // //         }`}
// // // //       >
// // // //         <td className="p-4">{item.lessonPlanTitle}</td>
